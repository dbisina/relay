...
pub struct SessionIntel {
    ...
    #[serde(default)] pub initial_prompt:  String,
    #[serde(default)] pub last_prompt:     String,
    #[serde(default)] pub last_activity:   String,
    #[serde(default)] pub plan:            Vec<String>,
    #[serde(default)] pub tasks_remaining: Vec<String>,
    #[serde(default)] pub files_touched:   Vec<String>,
    #[serde(default)] pub skills:          Vec<String>,
    #[serde(default)] pub mcps:            Vec<String>,
    #[serde(default)] pub tokens_in:       i64,
    #[serde(default)] pub tokens_out:      i64,
